...
const styles = StyleSheet.create({
  ...
  offPill: { backgroundColor: colors.cta, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6, minWidth: 40, alignItems: 'center' },
  ...
  reorderBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: colors.redBg, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  ...
  pill: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 999, borderWidth: 1.5, borderColor: colors.separator, backgroundColor: colors.card },
  ...
  submitBtn: { flex: 1, backgroundColor: colors.cta, borderRadius: 14, paddingVertical: 16, alignItems: 'center', justifyContent: 'center' },
  ...
  guardBtn: { marginTop: 20, backgroundColor: colors.cta, borderRadius: 14, paddingHorizontal: 28, paddingVertical: 14 },
  ...
  // Consignment chips
  consignPill: { backgroundColor: colors.orangeBg, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 6, marginTop: 4 },
  consignPillText: { color: colors.orange, fontSize: 11, fontWeight: '800', letterSpacing: 0.5 },
  consignHeaderPill: { backgroundColor: colors.orangeBg, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 4 },
  consignHeaderPillText: { color: colors.orange, fontSize: 9, fontWeight: '800', letterSpacing: 0.5 },
  creditPill: { backgroundColor: colors.blueBg, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 6, marginTop: 4 },
  creditHeaderPill: { backgroundColor: colors.blueBg, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 4 },
  ...
  agreeCardAmber: { backgroundColor: colors.orangeBg, borderColor: colors.orangeLine },
  agreeCardBlue: { backgroundColor: colors.blueBg, borderColor: colors.blueLine },
  ...
  homecareShortcutIcon: { width: 32, height: 32, borderRadius: 10, backgroundColor: colors.cta, alignItems: 'center', justifyContent: 'center' },
  ...
  groupHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.card, borderRadius: 16, borderWidth: 1, borderColor: colors.groupedBg, paddingHorizontal: 16, paddingVertical: 16, marginBottom: 10 },
  ...
  proBadge: { backgroundColor: colors.blue, borderRadius: 6, paddingHorizontal: 6, paddingVertical: 1.5 },
  equipBadge: { backgroundColor: colors.label, borderRadius: 6, paddingHorizontal: 6, paddingVertical: 1.5 },
