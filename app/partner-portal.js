...
const styles = StyleSheet.create({
  ...
  consignHeaderPill: { backgroundColor: colors.orangeBg, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 3 },
  ...
  creditHeaderPill: { backgroundColor: colors.blueBg, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 3 },
