...
export default function ConcernDetailScreen() {
  ...
  if (loading) {
    return (
      <View style={styles.container}>
        <CollapsibleHeader translateY={headerTranslateY} title="" onBack={onBack} isRTL={isRTL} />
  ...
  return (
    <View style={styles.container}>
      <CollapsibleHeader translateY={headerTranslateY} title={seo?.h1 || ''} onBack={onBack} isRTL={isRTL} />
