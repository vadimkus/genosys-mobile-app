...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: colors.label, paddingHorizontal: 16, paddingBottom: 20 },
  ...
  pointsCard: { flex: 1, backgroundColor: colors.card, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: colors.groupedBg },
  pointsValue: { color: colors.label, fontSize: 23, fontWeight: '900' },
  pointsLabel: { color: colors.mutedText, fontSize: 11, marginTop: 4 },
  ...
  scriptCard: { backgroundColor: colors.card, borderRadius: 16, borderWidth: 1, borderColor: colors.groupedBg, padding: 16, marginBottom: 12 },
  ...
  actions: { flexDirection: 'row', gap: 8, marginTop: 14, paddingTop: 14, borderTopWidth: 1, borderTopColor: colors.groupedBg },
  ...
  input: { backgroundColor: colors.card, borderRadius: 14, borderWidth: 1, borderColor: colors.separator, color: colors.label, fontSize: 14, paddingHorizontal: 14, paddingVertical: 12, marginBottom: 16 },
  notes: { minHeight: 76, textAlignVertical: 'top' },
  search: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: colors.card, borderRadius: 14, borderWidth: 1, borderColor: colors.separator, paddingHorizontal: 14, marginBottom: 8 },
  ...
  productRowActive: { borderColor: colors.accent, backgroundColor: colors.redBg },
