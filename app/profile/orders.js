...
const styles = StyleSheet.create({
  ...
  orderTotalsLabelMuted: { fontSize: 12, color: colors.placeholder, fontWeight: '600' },
  orderTotalsValue: { fontSize: 12, color: colors.label, fontWeight: '800' },
  orderTotalsValueMuted: { fontSize: 12, color: colors.placeholder, fontWeight: '700', textDecorationLine: 'line-through' },
  orderTotalsValueMutedSmall: { fontSize: 12, color: colors.placeholder, fontWeight: '700' },
