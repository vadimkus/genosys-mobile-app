...
const styles = StyleSheet.create({
  ...
  headSub: { ...T.captionSmall, color: colors.secondaryLabel, marginTop: 4 },
  ...
  pointsEarnedRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 6 },
  ...
  summaryToggle: { flexDirection: 'row', alignItems: 'center', gap: 6 },
