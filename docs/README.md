...
| Doc | Description |
|-----|-------------|
| [GENOSYS Rewards Wallet Passes (2026-09-15)](./SESSION_CHANGES_2026-09-15_WALLET_LOYALTY_PASSES_OTA.md) | OTA-capable, provider-gated Apple/Google loyalty-card save flow from the native membership card; signed URLs, EN/RU/AR and physical-device release gates. |
