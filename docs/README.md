...
| Doc | Description |
|-----|-------------|
| [App Footer Gold Shimmer OTA (2026-07-26)](./SESSION_CHANGES_2026-07-26_app-footer-gold-shimmer-ota.md) | Luxury gold shimmer + glow on the shared GENOSYS brand footer (web certificate pattern). Runtime 1.11.0 (group `3f146568`). |
