          ...
          <View style={styles.benefitsList}>
            {product.name === 'ALL FOR SENSITIVE SERUM' ? (
              ...
              <>
                ...
                <Text style={styles.benefitItem}>• Promotes Hair Growth - Stimulates hair follicle activity and supports natural hair regrowth</Text>
