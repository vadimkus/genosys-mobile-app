        ...
        <View style={styles.section}>
          ...
          <View style={styles.benefitsList}>
            {product.name === 'ALL FOR SENSITIVE SERUM' ? (
              ...
              <>
                <Text style={styles.benefitItem}>• Inhibits Hair Loss Causes</Text>
                <Text style={styles.benefitItem}>  Targets root causes including 5α-reductase inhibition to suppress DHT conversion</Text>
                <Text style={styles.benefitItem}>• Stimulates Hair Growth</Text>
                <Text style={styles.benefitItem}>  Supplies essential nutrients to hair follicles and promotes angiogenesis for new hair growth</Text>
                ...
                <Text style={styles.benefitItem}>• Deep Scalp Cleansing</Text>
                <Text style={styles.benefitItem}>  Removes keratin, sebum, and impurities for optimal treatment absorption</Text>
                <Text style={styles.benefitItem}>• Enhanced Absorption</Text>
                <Text style={styles.benefitItem}>  Roller device ensures deeper penetration of active ingredients</Text>
                <Text style={styles.benefitItem}>• Comprehensive Treatment</Text>
                <Text style={styles.benefitItem}>  Complete system addressing all aspects of hair loss and scalp health</Text>
              </>
