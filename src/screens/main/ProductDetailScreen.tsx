          ...
          <View style={styles.benefitsList}>
            {product.name === 'ALL FOR SENSITIVE SERUM' ? (
              ...
              <>
                ...
                <Text style={styles.benefitItem}>• Promotes Hair Regrowth{'\n'}  Accelerates angiogenesis and stimulates hair follicle activity for new growth</Text>
              ...
              <>
                ...
                <Text style={styles.benefitItem}>• Regulates Sebum Secretion - Controls excessive sebum production for balanced and healthy scalp environment</Text>
